...
<head>
	...
	<title><?php echo empty($title) ? ' ' : "$title | " ?>iGroups Phone System <?php echo (isset($counts))? '('.$counts[0]->new.')' : '' ?></title>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
	<meta name="ROBOTS" content="NOINDEX, NOFOLLOW" />
	<link rel="stylesheet" href="<?php echo asset_url('assets/c/iframe.css'); ?>" type="text/css" media="screen" />
	<link rel="stylesheet" href="<?php echo asset_url('assets/themes/bluelook/bootstrap.min.css'); ?>" type="text/css" media="screen" />
	<link rel="stylesheet" href="<?php echo asset_url('assets/themes/bluelook/jqueryui/jquery-ui-1.8.16.custom.css'); ?>" type="text/css" media="screen" />
...
-->
	<script type="text/javascript" src="/assets/themes/bluelook/js/jquery-1.6.2.min.js"></script>
	<script type="text/javascript" src="/assets/themes/bluelook/js/jquery-ui-1.8.16.custom.min.js"></script>
...
<script type="text/javascript" src="/assets/themes/bluelook/js/demo.js"></script>
