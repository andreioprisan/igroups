<head>
    <title><?= $this->lang->line('us_en_lycos_domains'); ?></title>
    <meta content="<?= $this->lang->line('us_en_lycos_domains_meta_description'); ?>" name="description"/>
    <meta content="<?= $this->lang->line('us_en_lycos_domains_meta_keywords'); ?>" name="keywords"/>
    <meta content="ALL" name="ROBOTS"/>
    <meta name="google-site-verification" content="5N0UfrGzf5ohNUyd204ev7mEUnsKlfjacoXTAK5UYvc" />
    <style> @import url('/asset/css/reset.css'); </style>
    <style> @import url('/asset/css/smoothness/jquery-ui-1.7.1.custom.css'); </style>
    <style> @import url('/asset/css/default.css'); </style>
    <style> @import url('/asset/css/default2.css'); </style>
    <style> @import url('/asset/css/www.css'); </style>
    <style> @import url('/asset/css/colors.css'); </style>
    <style> @import url('/asset/css/facebox.css'); </style>
...
"common_js_facebox_forwards":"<h2>E-mail Forwarding</h2><p>Directs all e-mail sent to a domain e-mail address to another e-mail address. For example, if your domain name is mydomain.com, you could set up sally@mydomain.com and have that e-mail forward to sally123@lycosmail.com, or wherever you have e-mail service.</p><p>If you want a catchall e-mail address for your domain, enter a * or default in the e-mail address field. By doing so, all incoming e-mail that does not match the addresses you've established for your domain will be accessible from your catchall account.</p><p><b>Please Note:</b>     If you add E-Mail forwards to a domain which already has one or more POP/IMAP e-Mail accounts, this change can take up to a few hours to take effect. </p>",
...
"common_js_facebox_faq_mailincluded":"<h2><a class='faq' name='emailincluded'>Q</a>: Is an e-mail account included with my domain name?</h2><p>Yes, Lycos Domains supports both POP and IMAP e-mail. You can configure up to 3 e-mail boxes.Lycos Domains also supports up to 3 e-mail forwards, in case you already have e-mail addresses you would like to have your mail forwarded to. (For example, if your domain is mydomain.com, all e-mail ending in @mydomain.com can be forwarded to an e-mail address that you're currently using.)</p>"
	...
	<script src="<?=base_url();?>/asset/js/countries.js" type="text/javascript"></script>
	<script src="<?=base_url();?>/asset/js/json2.js" type="text/javascript"></script>
	<script src="<?=base_url();?>/asset/js/jquery-1.4.2.min.js" type="text/javascript"></script>
	<script src="<?=base_url();?>/asset/js/jquery-ui-1.7.1.custom.min.js" type="text/javascript"></script>
	<script src="<?=base_url();?>/asset/js/jquery.getUrlParam.js" type="text/javascript"></script>
	<script src="<?=base_url();?>/asset/js/jquery.cookie.js" type="text/javascript"></script>
	<script src="<?=base_url();?>/asset/js/jquery.sprintf.js" type="text/javascript"></script>
	<script src="<?=base_url();?>/asset/js/jquery.i18n.js" type="text/javascript"></script>
	<script src="<?=base_url();?>/asset/js/origin.js" type="text/javascript"></script>
	<script src="<?=base_url();?>/asset/js/i18n.js" type="text/javascript"></script>
	<script src="<?=base_url();?>/asset/js/prices.js" type="text/javascript"></script>
	<script src="<?=base_url();?>/asset/js/facebox.js" type="text/javascript"></script>
	<script src="<?=base_url();?>/asset/js/jquery.simplemodal-1.2.3.min.js" type="text/javascript"></script>
	<script src="<?=base_url();?>/asset/js/form.js" type="text/javascript"></script>
	<script src="<?=base_url();?>/asset/js/cart.js?ver=1" type="text/javascript"></script>
	<script src="<?=base_url();?>/asset/js/search.js?ver=2" type="text/javascript"></script>
	<script src="<?=base_url();?>/asset/js/cctld.js?ver=1" type="text/javascript"></script>
	<script src="<?=base_url();?>/asset/js/common.js?ver=1" type="text/javascript"></script>
	<script src="<?=base_url();?>/asset/js/jquery.tablesorter.min.js" type="text/javascript"></script>
	<script src="<?=base_url();?>/asset/js/header.js?ver=1" type="text/javascript"></script>
	<script src="<?=base_url();?>/asset/js/domains.js" type="text/javascript"></script>
    <script src="http://ly.lygo.com/scripts/messages.js" type="text/javascript"></script>
    <script type="text/javascript">
	var ip = '209.202.205.1';
