		...
		<div id="vbx-context-menu" class="context-menu">
				...
				<div class="flow-details">
					<h2 class="flow-name-title">
						<span class="flow-name"  style="margin-top: 8px;"><?php echo $flow->name ?><a href="#flow-rename" id="flow-rename" class="action-mini" style="display: none;">edit</a></span>
				...
				<ul class="vbx-menu-items-right">
					<li class="menu-item"><a class="save-button btn large success" href="" style="margin-top: 8px;"><font color="white">Save</font></a></li>
					<li class="menu-item"><a class="close-button btn large navigate-away" href="<?php echo site_url('flows') ?>" style="margin-right: 10px;"> Close</a></li>
				</ul>
