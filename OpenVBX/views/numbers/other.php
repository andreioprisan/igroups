...
<div id="vbx-other-numbers" class="vbx-numbers-section" style="display: none;">
	<div class="vbx-numbers-section-info">
		...
		<p>Click &ldquo;Import Number&rdquo; to assign the number to a flow in iGroups. Assigning the number to a flow will overwrite existing Voice and SMS flows.</p>
	</div>
