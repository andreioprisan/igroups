	...
	var updateDevice = function(id, params) {
		$.ajax({
			...
			success: function(data) {
				...
				$('.error-dialog .error-message').text('Unable to update device.  Please try again or support at support@igrou.ps.');
	...
	$('.device .trash').live('click', function(event) {
		...
		$.ajax({
			...
			success: function(data) {
				...
				$('.error-dialog .error-code').text('');
				$('.error-dialog .error-message').text('Unable to delete number.  Please try again or support at support@igrou.ps.');
