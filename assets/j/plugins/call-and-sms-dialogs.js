...
jQuery(function($) {	
	...
	$('#incomingcalls2browserphone').live('click', function(e) {
		e.preventDefault();
		e.stopPropagation();
	
		var parent = $(this).closest('#incomingcalls2browserphone'),
			client_status = true,
			status = null;
		...
		if (client_status) {
			...
			$('.error-dialog .error-message')
				.text('The Browser Phone is not available. ' +
		...
		if (status) {
			$('#incomingcalls2browserphone').html('Accepting');
			$('#incomingcalls2browserphone').addClass('success');
			$('#incomingcalls2browserphone').removeClass('danger');
		} else {
			$('#incomingcalls2browserphone').html('Not Accepting');
			$('#incomingcalls2browserphone').removeClass('success');
			$('#incomingcalls2browserphone').addClass('danger');
		}
	});
});
